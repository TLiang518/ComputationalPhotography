...
void testSegment() {
    ...
    Segment horizontal_segment(Vec2f(0,0), Vec2f(10,0));
    Vec2f uv = horizontal_segment.XtoUV(Vec2f(5,5));
    Vec2f X = horizontal_segment.UVtoX(uv);
    //testing distance
    cout << "Checking distance for point on linesegment" << horizontal_segment.distance(Vec2f(0,0)) << " should be 0 " << endl;
    cout << "Checking distance for point should be 5 away" << horizontal_segment.distance(Vec2f(0,5)) << " should be 5 " << endl;
}
...
void testWarp() {
    // Overwrote my test in my final gitcommit :(
}
